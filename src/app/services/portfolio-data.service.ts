    ...
    return [
      {
        ...
        tags: ['Angular 17+', 'TypeScript', 'RxJS', 'NgRx', 'SCSS', 'Tailwind', 'Tailwind'],
      },
      {
        id: 2,
        icon: '◈',
        ...
        tags: ['Node.js', 'Java', 'NestJS', '.NET Core', 'REST APIs', 'Spring Boot', 'C#', 'PHP', 'Laravel'],
      },
      {
        id: 3,
        icon: '◎',
        ...
        subtitle: 'Data Layer',
        tags: ['PostgreSQL', 'MongoDB', 'Redis', 'MySQL', 'SQL Server', 'Oracle DB'],
      },
      {
        id: 4,
        icon: '◇',
        ...
        tags: ['AWS', 'Azure', 'Docker', 'CI/CD', 'GitHub Actions', 'Terraform'],
      },
    ];
  }
    ...
    return [
      {
        id: 1,
        number: '01',
        type: 'Arquitectura Limpia',
        name: 'Backend modular con Arquitectura Limpia y principios SOLID',
        description:
          'Proyecto de referencia que implementa una API backend aplicando Arquitectura Limpia, separación de capas (Domain, Application, Infrastructure) y buenas prácticas para lograr un código mantenible, testeable y escalable.',
        stack: ['Java', 'Spring Boot', 'Clean Architecture', 'Testing', 'Swagger', 'Base de Datos Relacional', 'Docker'],
        liveUrl: '#',
        githubUrl: 'https://github.com/VictorMMosqueraG/Clean_Architecture',
        featured: true,
      },
      {
        id: 2,
        number: '02',
        type: 'Arquitectura Hexagonal',
        name: 'Backend modular con Arquitectura Hexagonal',
        description:
          'Proyecto backend diseñado con Arquitectura Hexagonal, separando claramente dominio, aplicación e infraestructura para lograr un sistema desacoplado, testeable y fácil de extender ante nuevos requisitos.',
        stack: ['.NET', 'Arquitectura Hexagonal', 'Domain-Driven Design', 'Testing', 'Swagger', 'MongoDB', 'Docker'],
        liveUrl: '#',
        githubUrl: 'https://github.com/VictorMMosqueraG/Architecture_Hexagonal',
        featured: true,
      },
      {
        id: 3,
        number: '03',
        type: 'Aplicación de Facturación',
        name: 'Billing App para gestión de facturas',
        description:
          'Aplicación de facturación enfocada en la gestión de órdenes, clientes, productos y comprobantes, permitiendo crear, visualizar y administrar facturas de forma simple y organizada para negocios pequeños y medianos.',
        stack: ['Full Stack', 'Billing', 'Gestión de clientes', 'Gestión de productos', 'Angular', 'MongoDB'],
        liveUrl: '#',
        githubUrl: 'https://github.com/VictorMMosqueraG/Billing-App',
        featured: false,
      },
    ];
  }
    ...
    return [
      {
        ...
        name: 'Amazon AWS',
        date: 'Octubre 2023',
        verifyUrl: 'https://www.udemy.com/certificate/UC-3d1fd85f-2f94-4815-8362-2b0c3705f726/',
      },
      {
        id: 2,
        badge: 'Certificado',
        issuer: 'Udemy',
        name: 'Spring Framework 6 y Spring boot 3',
        date: 'Agosto 2024',
        verifyUrl: 'https://www.udemy.com/certificate/UC-54097cf3-7796-4053-a0b1-25c98a9ca3f5/',
      },
      {
        id: 3,
        badge: 'Completado',
        ...
        name: 'Docker',
        date: 'Febrero 2024',
        verifyUrl: 'https://www.udemy.com/certificate/UC-c2dfc46c-ef6b-44f1-969b-6f8975103aee/',
      },
      {
        id: 4,
        badge: 'Completado',
        ...
        date: 'Abril 2024',
        verifyUrl: 'https://www.credly.com/badges/a6321a4e-285b-4565-957d-8b18cbd5ff7c/linked_in_profile',
      },
      {
        id: 5,
        badge: 'Certificado',
        ...
        name: 'Scrum',
        date: 'Abr 2023',
        verifyUrl: 'https://media.licdn.com/dms/image/v2/D4E2DAQFCwtqGuSLWJQ/profile-treasury-document-images_1280/profile-treasury-document-images_1280/1/1708715654870?e=1773878400&v=beta&t=BMFHXFMbjB9ToSfSXYznoaAZAu-0pTpC0mD_wzu_aMs',
      },
    ];
  }
}
